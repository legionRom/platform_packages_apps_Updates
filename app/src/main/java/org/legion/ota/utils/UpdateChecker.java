...
import org.legion.ota.UpdaterApplication;
import org.legion.ota.activities.UpdaterActivity;
import org.legion.ota.misc.Constants;
import org.legion.ota.misc.State;
import org.legion.ota.misc.UpdateInfo;
import org.legion.ota.requests.UpdatesJsonObjectRequest;
import org.legion.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "org.legion.ota.action.UPDATE_CHECK_FINISHED";
