...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "ro.legion.build_date_utc";
    ...
    static final String PROP_DEVICE = "ro.legion.device";
    static final String PROP_BUILD_VERSION = "ro.legion.version";
    static final String PROP_VERSION_CODE = "ro.legion.ota.version_code";
    static final String OTA_URL = "https://raw.githubusercontent.com/legionos-devices/OTA/master/%s.json";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/legionos-devices/Updater-Stuff/master/%s.changelog";
    public static final String DOWNLOAD_PATH = "/data/system_updates/";
    static final String EXPORT_PATH = "Legion-Updates/";
}
